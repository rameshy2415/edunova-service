package com.edunova.module.student.controller;

import com.edunova.common.dto.ApiResponse;
import com.edunova.module.student.dto.StudentDto;
import com.edunova.module.student.dto.StudentEnrollmentRequest;
import com.edunova.module.student.dto.StudentResponseDTO;
import com.edunova.module.student.service.ParentService;
import com.edunova.module.student.service.StudentService;
...
public class StudentController {
    ...
    public ResponseEntity<ApiResponse<StudentDto.Response>> enroll(@Valid @RequestBody StudentEnrollmentRequest request) {

        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Student enrolled successfully", studentService.enroll(request)));
    }
