...
import com.edunova.module.admin.student.dto.Grade;
import com.edunova.module.admin.student.dto.GradeDTO;
import com.edunova.module.admin.student.dto.GradeSectionDTO;
...
public interface GradeRepository extends JpaRepository<Grade, UUID> {
    ...
    @Query("""
            SELECT new com.edunova.module.admin.student.dto.GradeDTO(
                g.id,
                g.name,
                g.displayName
            )
    ...
    @Query("""
            SELECT new com.edunova.module.admin.student.dto.GradeSectionDTO(
                g.id,
                g.name,
                g.displayName,
                g.order,
